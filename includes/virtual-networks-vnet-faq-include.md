...
Yes. Reference the [Azure limits article](../azure-subscription-service-limits#networking-limits) for specific numbers. All the subnets must be fully contained in the virtual network address space and should not overlap with one another.
